...
public class deselectpowerup : MonoBehaviour
{
    ...
    void ChangeSprite()
    {
        if(button.GetComponent<Image>().sprite.name != "Lock") {
            ...
            if(button.gameObject.name == "Slot1" && PlayerData.selectedVariablesCT[0]) { 
            ...
            } else if(button.gameObject.name == "Slot2" && PlayerData.selectedVariablesCT[1]) { 
                GetComponent<Image>().sprite = unselectedImage;
            ...
            } else if(button.gameObject.name == "Slot3" && PlayerData.selectedVariablesCT[2]) { 
                GetComponent<Image>().sprite = unselectedImage;
            ...
            } else if(button.gameObject.name == "Slot4" && PlayerData.selectedVariablesCT[3]) { 
                GetComponent<Image>().sprite = unselectedImage;
