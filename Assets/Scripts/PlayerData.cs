...
public class PlayerData : MonoBehaviour
{
    ...
    public static List<string> UnlockedPowerupNames = new List<string> {"FishingRod", "Torpedo", "WaterGun", "Beer", "SpeedBoost", "ForceField"}; // the names of the unlocked powerups always starts out with the fishing rod 

    //, "PurpleBoat"
    public static List<string> UnlockedBoatNames = new List<string> {"WoodenBoat","Dragpon boat"}; // the names of the unlocked powerups always starts out with the fishing rod 
