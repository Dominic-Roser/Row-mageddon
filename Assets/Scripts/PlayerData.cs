...
public class PlayerData : MonoBehaviour
{
    ...
    public static List<string> UnlockedPowerupNames = new List<string> {"FishingRod", "Beer", "WaterGun"}; // the names of the unlocked powerups always starts out with the fishing rod 
